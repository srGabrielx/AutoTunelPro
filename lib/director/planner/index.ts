...
export function createGenerationPlan(context: ResolvedMusicalContext): StrictGenerationPlan {
  ...
  return {
    ...
    bassProfile: context.preset?.bassProfile ?? { type: '808', slideProbability: 0.2, syncWithKick: 0.8, restProbability: 0.8 },
    drumProfile: context.preset?.drumProfile ?? { hatRolls: true, hatRollThreshold: 0.85, kickSyncopation: 0.6, kickDensity: 16, kickGapMin: 1, kickGapMax: 4, snareOn: [2, 4], snareDensity: 8, snareGapMin: 2, snareGapMax: 4 },
